...
uses
  SysUtils, Classes, DB, SqlExpr, FMTBcd, DBClient, Provider, Dialogs, IniFiles, Forms,
  Data.DBXInterBase, Data.DBXFirebird;
...
begin
  ...
  Result:= (Quant/Aux.FieldByName('UnidadeEstoque').AsFloat)*Aux.FieldByName('cubagem').AsFloat*1000;
end;
...
begin
  ...
  Result:= (Quant/Aux.FieldByName('UnidadeEstoque').AsFloat)*Aux.FieldByName('peso').AsFloat;
end;
