...
//        J:= PosEx(' ', Obs, I+6);
      ...
      Molda(TiraChar(CDS_FiltroCGCMFDest.AsString), '0', 4, 17, True, Result);
...
{      if CDS_MCliPro.RecNo > 1 then
      ...
      Molda('L', ' ', 91, 93, False, Result); //Unidade de medida - Tabela 3
      Molda(CDS_MCliProClassifFiscal.AsString, '0', 94, 101, True, Result);
      Molda('Q3', ' ', 102, 103, False, Result); //Código imposto - Tabela 4
      Molda(IntToStr(Round(CDS_MCliProQuantAtendida.AsFloat * 1000)), '0', 104, 114, True, Result);
      Molda(IntToStr(Round(CDS_MCliProQuantAtendida.AsFloat * 1000)), '0', 115, 125, True, Result); //Quant Unidade preço pedido
      Molda('L', ' ', 126, 128, False, Result); //Unidade Medida preço pedido
      Molda('1', '0', 129, 131, True, Result); //Unidade preço
      Molda(IntToStr(Round((CDS_MCliProPreco.AsFloat/CDS_MCliProUNIDADEESTOQUE.AsFloat)*83)), '0', 132, 142, True, Result);
      Molda(IntToStr(Round((CDS_MCliProPreco.AsFloat/CDS_MCliProUNIDADEESTOQUE.AsFloat)*CDS_MCliProQuantAtendida.AsFloat*83)), '0', 143, 153, True, Result);
